                            ...
                            try:
                                ...
                                if m.Nb_Seconde_Fonctionnement < 60:
                                    ...
                                    if m.Nb_Seconde_Fonctionnement < 3600:
                                        conn.send(bytes("<p>Temps de vol: {:.2f} min".format(m.Nb_Seconde_Fonctionnement/60), "ascii"))
                                    else:
                                        conn.send(bytes("<p>Temps de vol: {:.2f} h".format(m.Nb_Seconde_Fonctionnement/3600), "ascii"))
                                ...
                                conn.send(bytes('<p>Version PIC/Wipy: {}'.format(_Version), "ascii"))
                                conn.send(bytes('<p>Temps démarrage: {:.2f} s'.format(m.startup_time), "ascii"))
