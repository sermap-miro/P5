...
from wifi import Wifi_Init, Wifi_Perso, Wifi_Connect, Wifi_Local, Wifi_Lock, Wifi_Connect
    ...
    while True:
        try:
            ...
            if cmd[0] == 62: #caractère ">"
                ...
                conn.sendall('{} {} {} {} {}'.format(m.PIC_ASK('S'), m.version, ARRET_URGENCE(), m.batterie(), wifi_nom))
                conn.close()
