...
#Update
pycom-fwtool-cli --port /dev/ttyUSB0 --verbose  flash -t ../bin/WiPy-1.18.1.r1.tar.gz
...
#Restore
pycom-fwtool-cli --port /dev/ttyUSB0 --verbose copy -p fs1 -r -f ../bin/Version_39.bin
