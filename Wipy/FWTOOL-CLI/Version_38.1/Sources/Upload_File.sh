...
#Exemple pour l'envoi des fichiers web

#./Upload_File.sh web/AiCmirobot_menu_principal_begin.htm web/
#./Upload_File.sh web/AiCmirobot_menu_principal_end.htm web/
