...
#Reset Complet: 
pycom-fwtool-cli -v -p COM7 erase_all
...
#Update
pycom-fwtool-cli --port COM7 --verbose  flash -t WiPy-1.18.1.r1.tar.gz
...
#Restore
pycom-fwtool-cli --port COM7 --verbose copy -p fs1 -r -f Version_37.bin