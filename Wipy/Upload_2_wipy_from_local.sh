...
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_calibration.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_menu_principal_begin.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_menu_principal_end.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_header.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_info.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
#curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_clock.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_clock_header.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_conf_header.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_etat_header.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_planning.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_planning_header.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_edit_header.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCmirobot_wifi.htm ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/favicon.ico ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/



if (( "$1" == "1" )) ; then
echo -e "Upload d'un planning vierge"
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/planning.txt ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
...
#sleep 0.3
curl ${CURL_OPTION} -T ${WORKING_FOLDER}/AiCwebserver_CMD.py ftp://${LOGIN}:${PASS}@${IP}:${PORT}/flash/
