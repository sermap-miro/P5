...
void IRQ_Execution(unsigned char IRQ_Indice){
    switch (IRQ_Indice){
        ...
        case INDICE_IRQ_CAPOT:IRQ_CAPOT(); break;
        case INDICE_IRQ_I_MOTEUR_1:IRQ_I_MOTEUR_1(); break;
        case INDICE_IRQ_I_MOTEUR_2:IRQ_I_MOTEUR_2(); break;
        case INDICE_IRQ_PION_RISING_EDGE:IRQ_PION_RISING_EDGE(); break;
        case INDICE_IRQ_PION_FALLING_EDGE:IRQ_PION_FALLING_EDGE(); break;
        case INDICE_IRQ_TIMER_0:IRQ_TIMER_0(); break;
        case INDICE_IRQ_TIMER_2:IRQ_TIMER2(); break;
        case INDICE_IRQ_TIMER_5:IRQ_TIMER_5(); break;
        case INDICE_IRQ_ADC:IRQ_ADC(); break;
        case INDICE_IRQ_PWM: IRQ_PWM(); break;
        default: break;
