...
#define _XTAL_FREQ 8000000 //The speed of your internal(or)external oscillator
    ...
    extern unsigned long long Compteur_Fonctionnement;
    
    extern unsigned int Batterie_mV;
    
    extern unsigned char P4_busy;
...
//#define DVT_TABLEAU_TAILLE 6
    ...
    extern unsigned char nb_s_fonctionnement_souhaiter;
    ...
    extern unsigned char nb_100ms_platine_backup;
//    extern unsigned char nb_100ms_platine_fin;
    ...
    extern volatile char Consigne_Max;
    extern volatile char Consigne_Max_Moteur_X;
    extern volatile char Consigne_Max_Moteur_Z;
    extern volatile char Consigne_Max_Moteur_Bequille;
    
    extern unsigned char Moteur_I_Max;
    extern unsigned char Pelle_I_Max;
    extern unsigned char Bequille_I_Max;
    
    
    
    extern bit Option_Multitas;
    extern bit Option_Pailleux;
    
    extern unsigned char type_consigne;
    extern unsigned char mouvement_option;
   ...
   extern volatile unsigned char delay_s_counter;
     ...
     extern unsigned char Surveillance_Consommation_Moteur_1;
     extern unsigned char Surveillance_Consommation_Moteur_2; 
     
    extern unsigned char Surveillance_Capteur_Pion;
      
    extern volatile unsigned char Compteur_IRQ_I_Moteur_1;
    extern volatile unsigned char Compteur_IRQ_I_Moteur_2;
...
extern volatile bit SPI_MODE;

extern volatile unsigned char spiTxIndex; //index du buffer de transmission
extern volatile unsigned char spiTxBuffer[SPI_TX_BUFFER_SIZE]; //Buffer d'émission

extern volatile unsigned char spiRxIndex; //index du buffer de transmission
extern volatile unsigned char SPI_RX_TEXT[SPI_RX_BUFFER_SIZE];
extern volatile unsigned char spiRxBuffer[SPI_RX_BUFFER_SIZE]; //Buffer de réception


extern volatile unsigned char eusart1TxBuffer_Test[10];
extern volatile bit UART_TEST;

 extern volatile bit RX1_ABR; // Variable de l'autobaudrate
