    ...
    switch (moteur_indice) {
        ...
        case MOTEUR_1:
            ...
            nb_Pion = 0;
                ...
                Mouvement_Startup = 1;
          #ifdef PROTO_2      
            if(PION == 1){//Si lors du démarrage du moteur
...
void Moteur_Mvt(unsigned char moteur_indice, unsigned char direction, unsigned char type_consigne, unsigned char option) {
    //unsigned char i; //, i_min, i_max;
    unsigned char i, i_min, i_max;
    unsigned char Option_Temps_S;
    //    unsigned int erreur;
